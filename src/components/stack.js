...
import { faBootstrap, faCss3Alt, faHtml5, faJs, faNodeJs, faReact, faSass, faWordpressSimple } from '@fortawesome/free-brands-svg-icons'
      ...
      <Row id="tech-icons" className="my-5 justify-content-center">
        ...
        <Col lg={true} xs={6} md={true} className="my-3">
          ...
          <FontAwesomeIcon style="max-width: 112px" icon={faWordpressSimple} id="wordpress" className="fa-5x fa-fw m-auto w-100" />
				...
				<Col lg={true} xs={6} md={true} className="my-3">
					<div className="position-relative" data-target="#react" data-tooltip="React">
						<FontAwesomeIcon style="max-width: 112px" icon={faReact} id="wordpress" className="fa-5x fa-fw m-auto w-100" />
					</div>
				</Col>
        <Col lg={true} xs={6} md={true} className="my-3">
