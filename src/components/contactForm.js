  ...
  return (
    <Form name="Contact Form" className="contact-form" method="POST" data-netlify="true" ref={form}>
      <Row className="px-3 px-sm-0">
        <Col md={7}>
          <Form.Control ref="form-name" type="hidden" value="Contact Form"></Form.Control>
          <Form.Group controlId="name" className="pt-3">
            <Form.Label>Name</Form.Label>
            <Form.Control ref="name" type="text" placeholder="Johnny Cash" required />
          </Form.Group>
          <Form.Group controlId="email" className="py-3">
            <Form.Label>Email address</Form.Label>
            <Form.Control ref="email" type="email" placeholder="johnny@maninblack.com" required />
          </Form.Group>
          <Form.Group controlId="message" className="pb-3">
            <Form.Label>Your Message</Form.Label>
            <Form.Control ref="message" as="textarea" rows="5" placeholder="Hello, I'm Johnny Cash..." /*placeholder="I keep a close watch on this heart of mine&#10;I keep my eyes wide open all the time..."*/ required />
          </Form.Group>
